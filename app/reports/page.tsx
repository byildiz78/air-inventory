            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-medium">Aylık Stok Raporu</h4>
                    <p className="text-sm text-muted-foreground">
                      Ocak 2024 stok durumu
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-medium">Reçete Kullanım Raporu</h4>
                    <p className="text-sm text-muted-foreground">
                      Son 30 gün reçete kullanımları
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-sm text-muted-foreground">14.01.2024</span>
                  <Button variant="outline" size="sm">
                    <Download className="w-4 h-4" />
                  </Button>
                </div>
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-medium">Karlılık Analizi</h4>
                    <p className="text-sm text-muted-foreground">
                      2023 Q4 karlılık raporu
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-sm text-muted-foreground">10.01.2024</span>
                  <Button variant="outline" size="sm">
                    <Download className="w-4 h-4" />
                  </Button>
                </div>
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-medium">Tedarikçi Maliyet Karşılaştırması</h4>
                    <p className="text-sm text-muted-foreground">
                      Et ürünleri tedarikçi analizi
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-sm text-muted-foreground">05.01.2024</span>
                  <Button variant="outline" size="sm">
                    <Download className="w-4 h-4" />
                  </Button>
                </div>
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg hover:bg-gray-50 transition-colors">
                <div className="flex items-center gap-3">
                  <FileText className="w-5 h-5 text-blue-600" />
                  <div>
                    <h4 className="font-medium">Stok Hareket Raporu</h4>
                    <p className="text-sm text-muted-foreground">
                      Aralık 2023 stok hareketleri
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-sm text-muted-foreground">02.01.2024</span>
                  <Button variant="outline" size="sm">
                    <Download className="w-4 h-4" />
                  </Button>
                </div>
