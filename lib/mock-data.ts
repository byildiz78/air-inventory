...
// Satış Malları için mock data interfaces
export interface MockSalesItemCategory {
  id: string;
  name: string;
  description?: string;
  color: string;
...
export interface MockSalesItemGroup {
  id: string;
  name: string;
  categoryId: string;
  description?: string;
...
export interface MockSalesItem {
  id: string;
  name: string;
  categoryId: string;
  groupId?: string;
...
export interface MockRecipeMapping {
  id: string;
  salesItemId: string;
  recipeId: string;
  portionRatio: number;
