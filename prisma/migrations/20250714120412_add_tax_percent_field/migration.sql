...
INSERT INTO "new_sales_items" ("basePrice", "categoryId", "createdAt", "description", "groupId", "id", "isActive", "isAvailable", "menuCode", "name", "sortOrder", "updatedAt") SELECT "basePrice", "categoryId", "createdAt", "description", "groupId", "id", "isActive", "isAvailable", "menuCode", "name", "sortOrder", "updatedAt" FROM "sales_items";
